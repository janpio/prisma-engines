...
fn postgres_apply_migrations_errors_give_precise_location(api: TestApi) {
    ...
    let expectation = expect![[r#"
        ...
        DbError { severity: "ERROR", parsed_severity: Some(Error), code: SqlState("42P01"), message: "relation \"Dog\" does not exist", detail: None, hint: None, position: Some(Original(133)), where_: None, schema: None, table: None, column: None, datatype: None, constraint: None, file: Some("parse_relation.c"), line: Some(1194), routine: Some("parserOpenTable") }
...
fn postgres_apply_migrations_errors_give_precise_location_at_the_beginning_of_files(api: TestApi) {
    ...
    let expectation = expect![[r#"
        ...
        DbError { severity: "ERROR", parsed_severity: Some(Error), code: SqlState("42P01"), message: "relation \"Dog\" does not exist", detail: None, hint: None, position: Some(Original(81)), where_: None, schema: None, table: None, column: None, datatype: None, constraint: None, file: Some("parse_relation.c"), line: Some(1194), routine: Some("parserOpenTable") }
